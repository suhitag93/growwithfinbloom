...
const Auth = () => {
  ...
  return (
    <div className="flex flex-col bg-background px-4" style={{ minHeight: "100dvh" }}>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="w-full max-w-lg mx-auto flex-1 flex flex-col justify-center py-8 space-y-6"
      >
        {/* Brand */}
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            {isLogin
              ...
              : "Create an account to begin your financial bloom"}
          </p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <button
            ...
            className="text-primary font-medium hover:underline min-h-[44px]"
          >
